...
export default function Service4() {
  return (
    <>
      <Head>
        <title>Service 4 | PixelPulse Digital Agency</title>
        <meta name="description" content="Learn more about Service 4 offered by PixelPulse Digital Agency." />
      </Head>
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#fff', color: '#171717' }}>
        ...
        <main style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '3rem 2vw', textAlign: 'center' }}>
          <h1 style={{ fontSize: '2.2rem', fontWeight: 900, marginBottom: '2.2rem', color: '#171717' }}>Service 4</h1>
        </main>
      </div>
    </>
  );
